...
import com.hamza.veterinarysystemdemo.UserProblemsActivity;
...
public class DoctorDrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar=findViewById(R.id.ds_loading);
        adminPostRecycler = findViewById(R.id.recycler_admin_posts_doctor);
        ...
        HeaderName = headerView.findViewById(R.id.nav_header_doctor_name);
        HeaderProfileImage = headerView.findViewById(R.id.nav_header_doctor_pic);
        userSessionManager = new UserSessionManager(this);
        prettyDialog = new PrettyDialog(this);
        sessionDetails = userSessionManager.getSessionDetails();
        UserNameHeader = sessionDetails.getName();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.doctor_drawer, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.dots_doctor_cLanguage) {
            ...
            return true;
        } else if (id == R.id.dots_doctor_contacts) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_doctor_userproblems) {
            sendDoctorToUserProblemsActivity();
            // Handle the camera action
        } else if (id == R.id.nav_doctor_appointments) {
            sendDoctorToAppointmentActivity();
        } else if (id == R.id.nav_doctor_cart) {
            sendDoctorToCartActivity();

        } else if (id == R.id.nav_doctor_history) {

            SendDoctorToHistory();
        } else if (id == R.id.nav_doctor_medicine) {
            sendDoctorToMedicinesActivity();

        } else if (id == R.id.nav_doctor_settings) {
            sendDoctorToSettingsActivity();

        } else if (id == R.id.nav_doctor_logout) {
            sendDoctorToLoginActivity();
    ...
    private void SendDoctorToHistory() {
        Intent usersAppointmentIntent = new Intent(getApplicationContext(), HistoyDoctorActivity.class);
        startActivity(usersAppointmentIntent);
    }

    private void sendDoctorToAppointmentActivity() {
        Intent usersAppointmentIntent = new Intent(getApplicationContext(), DoctorAppointmentActivity.class);
        startActivity(usersAppointmentIntent);
    }

    private void sendDoctorToUserProblemsActivity() {
        Intent usersProblemsIntent = new Intent(getApplicationContext(), UserProblemsActivity.class);
        startActivity(usersProblemsIntent);
    }

    private void sendDoctorToCartActivity() {
        Intent cartintent = new Intent(getApplicationContext(), CartActivity.class);
        startActivity(cartintent);
    }

    private void sendDoctorToLoginActivity() {
    ...
    private void sendDoctorToSettingsActivity() {
        Intent settingsintent = new Intent(getApplicationContext(), SettingsActivity.class);
        startActivity(settingsintent);
    }

    private void sendDoctorToMedicinesActivity() {
