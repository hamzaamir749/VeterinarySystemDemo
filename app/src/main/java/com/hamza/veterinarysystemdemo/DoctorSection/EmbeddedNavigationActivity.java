...
public class EmbeddedNavigationActivity extends AppCompatActivity implements OnNavigationReadyCallback,
    ...
    Double doclat,doclang,userlat,userlang;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        doclat=Double.valueOf(getIntent().getExtras().get("docLat").toString());
        doclang=Double.valueOf(getIntent().getExtras().get("docLang").toString());
        userlat=Double.valueOf(getIntent().getExtras().get("userLat").toString());
        userlang=Double.valueOf(getIntent().getExtras().get("userLang").toString());
        ORIGIN=Point.fromLngLat(doclang, doclat);
        DESTINATION=Point.fromLngLat(userlang,userlat);
    ...
    public void onNavigationFinished() {
        // Intentionally empty
        Intent intentfinish=new Intent(getApplicationContext(),DoctorAppointmentActivity.class);
        intentfinish.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
