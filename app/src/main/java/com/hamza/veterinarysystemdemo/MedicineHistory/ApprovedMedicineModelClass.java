...
public class ApprovedMedicineModelClass {
    public String medicineid,storeid,medicinename,medicineprice,medicinequantity,medicineimage,time,date;

    public ApprovedMedicineModelClass(String medicineid, String storeid, String medicinename, String medicineprice, String medicinequantity, String medicineimage, String time, String date) {
